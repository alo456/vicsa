 ...
 */
final class Version20181021082324 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE address ALTER ext_number TYPE VARCHAR(30)');
        $this->addSql('ALTER TABLE address ALTER ext_number DROP DEFAULT');
        $this->addSql('ALTER TABLE address ALTER in_number TYPE VARCHAR(30)');
        $this->addSql('ALTER TABLE address ALTER in_number DROP DEFAULT');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE address ALTER ext_number TYPE INT');
        $this->addSql('ALTER TABLE address ALTER ext_number DROP DEFAULT');
        $this->addSql('ALTER TABLE address ALTER ext_number TYPE INT');
        $this->addSql('ALTER TABLE address ALTER in_number TYPE INT');
        $this->addSql('ALTER TABLE address ALTER in_number DROP DEFAULT');
        $this->addSql('ALTER TABLE address ALTER in_number TYPE INT');
    }
}
