 ...
 */
final class Version20181101082141 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE device DROP public_price');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE device ADD public_price DOUBLE PRECISION DEFAULT NULL');
    }
}
