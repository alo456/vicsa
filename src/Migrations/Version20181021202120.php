 ...
 */
final class Version20181021202120 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activation DROP status');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activation ADD status VARCHAR(2) NOT NULL');
    }
}
