 ...
 */
final class Version20181024213659 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note ALTER payment_term TYPE VARCHAR(50)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note ALTER payment_term TYPE VARCHAR(4)');
    }
}
